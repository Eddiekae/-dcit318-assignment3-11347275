...
public class InventoryLogger<T> where T : IInventoryEntity
{
    ...
    public void SaveToFile()
    {
        ...
        {
            Console.WriteLine($"Access denied while saving to file: {ex.Message}");
        }
        ...
        {
            Console.WriteLine($"IO error while saving file: {ex.Message}");
        }
        catch (Exception ex)
        {
    ...
    public void LoadFromFile()
    {
        ...
        {
            Console.WriteLine($"IO error while loading file: {ex.Message}");
        }
        catch (Exception ex)
        {
...
public class ImmutableInventoryProgram
{
    public static void Main(string[] args)
    {
        Console.WriteLine("=== Immutable Inventory Management System ===");
        Console.WriteLine("This system demonstrates immutable data records, generics, and file operations.");
        Console.WriteLine();
        
        string inventoryFile = "immutable_inventory.json";
